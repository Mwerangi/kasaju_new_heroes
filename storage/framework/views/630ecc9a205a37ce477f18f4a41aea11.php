        ...
        <div class="max-w-5xl mx-auto">
            <div class="text-center mb-12">
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-16">
                    <a href="<?php echo e(route('quote')); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white px-10 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105 shadow-lg">
                        Request a Quote
                    </a>
                    <a href="<?php echo e(route('services')); ?>" class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-10 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105">
                        Our Services
                    </a>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
                ...
                <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold text-lg">
                    Learn More About Us
            ...
            <div class="relative">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src="<?php echo e(asset('assets/images/bandari.webp')); ?>" alt="Port Operations" class="w-full h-96 object-cover">
                </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16">
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                <img src="<?php echo e(asset('assets/images/roro-car-shipping-02.webp')); ?>" alt="RoRo Car Shipping" class="w-full h-72 object-cover transform group-hover:scale-110 transition-transform duration-500">
            ...
            <!-- Container Shipping -->
            <div class="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                <img src="<?php echo e(asset('assets/images/Shipping-cars.jpg')); ?>" alt="Container Shipping" class="w-full h-72 object-cover transform group-hover:scale-110 transition-transform duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex items-end">
                    <div class="p-6 text-white">
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <?php $__empty_1 = true; $__currentLoopData = $featuredServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    <?php if($service->image): ?>
                        <div class="relative overflow-hidden h-56">
                            <img src="<?php echo e(asset('storage/' . $service->image)); ?>" alt="<?php echo e($service->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div class="p-8">
                        <div class="text-sm font-bold text-blue-600 mb-3"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition"><?php echo e($service->title); ?></h3>
                        <p class="text-gray-600 mb-6 leading-relaxed"><?php echo e($service->short_description); ?></p>
                        <a href="<?php echo e(route('services.show', $service->slug)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold group-hover:gap-3 transition-all">
                            Discover More
                            <i class="fas fa-arrow-right ml-2"></i>
                        </a>
                    </div>
        ...
        <?php if($featuredServices->count() > 0): ?>
            <div class="text-center mt-16">
                <a href="<?php echo e(route('services')); ?>" class="inline-block bg-blue-900 hover:bg-blue-800 text-white px-10 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105 shadow-lg">
                    View All Services
                </a>
            </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    ...
                    <p class="text-gray-700 mb-6 leading-relaxed text-lg italic">"<?php echo e($testimonial->testimonial); ?>"</p>
                    <div class="flex items-center pt-6 border-t border-gray-100">
                        <?php if($testimonial->image): ?>
                            <img src="<?php echo e(asset('storage/' . $testimonial->image)); ?>" alt="<?php echo e($testimonial->client_name); ?>" class="w-14 h-14 rounded-full mr-4 object-cover">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <h4 class="font-bold text-gray-900"><?php echo e($testimonial->client_name); ?></h4>
                            <?php if($testimonial->company_name): ?>
                                <p class="text-sm text-gray-500"><?php echo e($testimonial->company_name); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<section class="relative py-24 text-white overflow-hidden">
    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('<?php echo e(asset('assets/images/Shipping-cars.jpg')); ?>');"></div>
    ...
    <div class="container mx-auto px-4 text-center relative z-10">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-10 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105">
                Contact Us
            </a>
        </div>
    </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Documents/Projects/New_heros/resources/views/web/home.blade.php ENDPATH**/ ?>