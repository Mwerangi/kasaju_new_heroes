<?php $__env->startSection('title', $service->meta_title ?? $service->title . ' - New Heroes International'); ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl">
            ...
            <div class="flex items-center text-sm text-gray-500 mb-6">
                <a href="<?php echo e(route('home')); ?>" class="breadcrumb-link">Home</a>
                <i class="fas fa-chevron-right mx-3 text-xs"></i>
                <a href="<?php echo e(route('services')); ?>" class="breadcrumb-link">Services</a>
                <i class="fas fa-chevron-right mx-3 text-xs"></i>
                <span class="text-gray-900"><?php echo e($service->title); ?></span>
            </div>
                    ...
                    <div class="mt-16 pt-16 border-t border-gray-200">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            <?php $__currentLoopData = $relatedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('services.show', $related->slug)); ?>" 
                                    ...
                                    <?php if($related->icon): ?>
                                        <div class="mb-4 text-blue-600 text-3xl">
                                            <i class="<?php echo e($related->icon); ?>"></i>
                                        </div>
                                    ...
                                    <p class="text-sm text-gray-600 leading-relaxed"><?php echo e(Str::limit($related->short_description, 80)); ?></p>
                                </a>
            ...
            <div class="lg:col-span-1">
                <div class="sidebar-card space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-2xl p-8 shadow-xl">
                        ...
                        <a href="<?php echo e(route('quote')); ?>" class="block w-full px-6 py-4 bg-white text-blue-600 text-center rounded-full font-semibold hover:bg-blue-50 transition-all hover:scale-105">
                            Request a Quote →
                        </a>
                    </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-wrap gap-4 justify-center">
                ...
                <a href="<?php echo e(route('services')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-gray-900 transition-all">
                    View All Services
                </a>
            </div>
        </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Documents/Projects/New_heros/resources/views/web/services/show.blade.php ENDPATH**/ ?>