            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Max 5MB. Supports: JPG, PNG, WEBP, GIF, SVG, BMP, ICO, AVIF</p>
                        @error('image')
                    ...
                    <div>
                        ...
                        <textarea name="caption" id="caption" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('caption') border-red-500 @enderror">{{ old('caption') }}</textarea>
                        @error('caption')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
