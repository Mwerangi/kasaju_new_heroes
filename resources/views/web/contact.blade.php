            ...
            <div class="grid lg:grid-cols-5 gap-12">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-3xl p-8">
                        ...
                        <div class="space-y-3">
                            <div class="py-2">
                                <p class="text-white leading-relaxed">{{ $workingHours }}</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <div class="text-lg text-gray-600">
                    <p class="font-semibold">{{ $officeAddress }}</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ $phoneLink }}" class="px-8 py-4 bg-white text-blue-600 rounded-full font-semibold hover:bg-blue-50 hover:scale-105 transition">
                    <i class="fas fa-phone mr-2"></i> Call Us Now
                </a>
                <a href="{{ $whatsappLink }}" target="_blank" class="px-8 py-4 bg-green-500 text-white rounded-full font-semibold hover:bg-green-600 hover:scale-105 transition">
