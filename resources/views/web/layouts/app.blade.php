                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="tel:{{ str_replace(' ', '', $phone1) }}" class="text-gray-400 hover:text-white transition">{{ $phone1 }}</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <i class="fab fa-whatsapp text-yellow-500"></i>
                            <a href="https://wa.me/{{ str_replace([' ', '+', '-'], '', $whatsapp) }}" target="_blank" class="text-gray-400 hover:text-white transition">{{ $phone2 }}</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <i class="fas fa-envelope text-yellow-500"></i>
                            <a href="mailto:{{ $email }}" class="text-gray-400 hover:text-white transition">{{ $email }}</a>
                        </li>
                    </ul>
                </div>
            </div>
